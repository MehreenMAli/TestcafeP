...
test(`TC 27324: Edition Table`, async t => {
    ...
    const tableName = '27324_TestTable';
    const tableNameEdit = '27324_EditTest';
    ...
    await t
        ...
        try {
            ...
            await t
                ...
                try {
                    await t
                        ...
                        .typeText(glTablePage.tableNameInput.nth(tableIndex), tableNameEdit, { paste: true, replace: true})
                        .click(glTablePage.saveButton)
                        .expect(confirmModal.body.innerText).contains(labels['ui-gltable-018'], 'Confirmation message was not displayed', timeout)
                        .click(confirmModal.acceptButton);
                } catch (err) {
            ...
            customerTables = (await apiHandler.getCustomerTables(corcentricCustomer.client_id)).items;
            testTable = customerTables.find(element => element.table_name === tableNameEdit);
            if (testTable) {
